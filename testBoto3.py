...
class FaceRecognition:
    def __init__(self, known_faces_dir='known_faces', new_faces_dir='new_faces', log_interval=10, region_name='us-east-1', process_interval=5):
        ...
        self.rekognition = boto3.client("rekognition", region_name="ap-southeast-1")
        self.encode_faces()
        self.face_locations = []
        self.face_names = []
